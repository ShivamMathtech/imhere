...
const jobsByIdCtrls = require("../../controller/customerCtrls/jobRequestsById");
...
customerRouter.get("/requests/:id", authMiddlerware, jobsByIdCtrls); // get specific service by the customer
